...
function StatBarSkeleton() {
  return (
    <Stack direction="row" spacing={1} sx={{ alignItems: "center" }}>
      ...
      <Skeleton variant="rounded" height={7} sx={{ flexGrow: 1, borderRadius: "4px" }} />
...
export function PokemonCardSkeleton() {
  return (
    <Box
      ...
      sx={{ position: "relative", height: "100%", borderRadius: "20px", overflow: "hidden" }}
    >
      <Box
        sx={{
          position: "absolute",
      ...
      >
        ...
        >
          ...
          <Skeleton variant="rounded" width={40} height={20} sx={{ borderRadius: "8px" }} />
        </Box>
        ...
        <Stack sx={{ flexGrow: 1, px: 1.5, py: 1.25 }} spacing={1}>
          <Stack direction="row" spacing={0.75} sx={{ flexWrap: "wrap" }}>
            <Skeleton variant="rounded" width={55} height={22} sx={{ borderRadius: "11px" }} />
            <Skeleton variant="rounded" width={55} height={22} sx={{ borderRadius: "11px" }} />
          </Stack>
